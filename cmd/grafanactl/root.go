// Copyright © 2018 Juan Mesa <linuxven@gmail.com>
//
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.grafanactl.yaml)")
}
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".grafanactl" (without extension).
